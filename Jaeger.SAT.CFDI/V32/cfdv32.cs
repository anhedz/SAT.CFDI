...
using Jaeger.SAT.CFDI.Complemento.TimbreFiscal.V10;
    ...
    public partial class Comprobante {
        ...
        public static Comprobante LoadBytes(byte[] xmlBytes) {
            ...
            try {
                ...
                Console.WriteLine("CFDIv32: " + ex.Message);
                return null;
            }
        ...
        public virtual string Serialize() {
            ...
            using (MemoryStream memoryStream = new MemoryStream()) {
                XmlWriter xmlWriter = XmlWriter.Create(memoryStream, xmlWriterSetting1);
                ...
                this.XsiSchemaLocation = "http://www.sat.gob.mx/cfd/3 http://www.sat.gob.mx/sitio_internet/cfd/3/cfdv32.xsd";
                ...
                if (this.Complemento != null) {
                    try {
                        ...
                        while (enumerator.MoveNext()) {
                            ...
                            string str = name;
                            if (name != null) {
                                if (str == "nomina11:Nomina") {
                                    xmlSerializerNamespace.Add("nomina12", "http://www.sat.gob.mx/nomina11");
                                    this.XsiSchemaLocation = string.Concat(this.XsiSchemaLocation, " http://www.sat.gob.mx/nomina http://www.sat.gob.mx/sitio_internet/cfd/nomina/nomina11.xsd");
                                } else if (str == "nomina12:Nomina") {
        ...
        public string CadenaOriginal {
            get {
                ...
                using (Stream manifestResourceStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Jaeger.SAT.CFDI.xslt.cadenaoriginal_3_2.xslt")) {
        ...
        public string CadenaOriginalOff {
            get {
                string outOriginalString;
                using (Stream manifestResourceStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Jaeger.SAT.CFDI.xslt.cadenaoriginal_3_2_offline.xslt")) {
                    if (manifestResourceStream == null) {
                        outOriginalString = null;
                    } else {
                        XmlDocument xmlDocument = new XmlDocument();
...
namespace Jaeger.SAT.CFDI.V32 {
    ...
    public partial class ComprobanteConcepto {
        ...
        [System.Xml.Serialization.XmlElementAttribute("InformacionAduanera", typeof(TInformacionAduanera))]
...
namespace Jaeger.SAT.CFDI.V32 {
    ...
    public partial class ComprobanteComplemento {
        ...
        /// <summary>
        /// complemento timbre fiscal ver. 10
        /// </summary>
        [XmlIgnore]
            ...
            get {
                ...
                try {
                    while (enumerator.MoveNext()) {
                        ...
                        if (current.Name != "tfd:TimbreFiscalDigital") {
                            continue;
                        }
        ...
        [XmlIgnore]
        public Jaeger.SAT.CFDI.Complemento.Nomina.V11.Nomina Nomina11 {
            get {
                Jaeger.SAT.CFDI.Complemento.Nomina.V11.Nomina nomina11;
                List<XmlElement>.Enumerator enumerator = this.anyField.GetEnumerator();
                try {
                    while (enumerator.MoveNext()) {
                        XmlElement current = enumerator.Current;
                        string name = current.Name;
                        if (name == null || name != "nomina:Nomina") {
                            continue;
                        }
                        nomina11 = Jaeger.SAT.CFDI.Complemento.Nomina.V11.Nomina.Deserialize(current.OuterXml);
                        return nomina11;
                    }
                    return null;
                } catch (Exception) {
